...
The Hib_efficacy code authored by A Deol on Github was derived from the  rotavirus_vaccine_efficacy code authored by K Van Zandvoort. The purpose is to estimate the cumulative vaccine efficacy as well as the instantaneous vaccine effacy - using various methods for the latter. 



```{r rotavirus_vaccine_efficacy_index, vaccine_efficacy_data}
library(ggplot2)
library(gridExtra)
...
Plots for each waning function. 

waning_gamma_01

```{r vaccine_efficacy_data_VE,vaccine_efficacy_data_iVE,vaccine_efficacy_central_VE,vaccine_efficacy_central_iVE,vaccine_efficacy_central_iVE_calc, include=FALSE, echo=FALSE}
VEdat <- ggplot()+
