...
The Hib_efficacy code authored by A Deol on Github was derived from the  rotavirus_vaccine_efficacy code authored by K Van Zandvoort. The purpose is to estimate the cumulative vaccine efficacy as well as the instantaneous vaccine effacy - using various methods for the latter. First plot with 6 panels is the original output
...
library(ggplot2)
library(gridExtra)
source("rotavirus_vaccine_efficacy_index.r")
